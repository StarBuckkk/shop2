...
public class ItemViewByUser extends AppCompatActivity {
    ...
    private String TAG = "StarBuck_MAINACTIVITY2";
    ...
    {
        UserClothesBtn = (Button) findViewById(R.id.clothes_user_btn);
        ...
        UserShoesBtn = (Button) findViewById(R.id.shoes_user_btn);
        ...
        UserAccBtn = (Button) findViewById(R.id.acc_user_btn);
        ...
        UserBackBtn = (Button) findViewById(R.id.back_user_btn);
